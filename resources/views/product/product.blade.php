...
<div class="content">
  ...
  <tbody>
    ...
    @foreach ($datosProduct as $Product )
          <tr>
              <td>{{ $Product->id }}</td>
              <td>{{ $Product->name_product }}</td>
              <td>{{ $Product->description_product }}</td>
              <td>{{ $Product->quantity }}</td>
              <td>{{ $Product->categoria->name_categorie }}</td>
              <td>{{ $Product->proveedor->name_provider}}</td>
              <td>
  ...
  <a style="margin-left: 70%; margin-top:20%;"  href="{{route('Product.create')}}"><i style="font-size:70px; color: #008037" class="bi bi-plus-circle-fill" ></i></a>
