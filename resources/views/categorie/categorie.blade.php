...
<div class="content">
  ...
  <tbody>
    ...
    @foreach ($datosCategorie as $Categorie )
          <tr>
              <td>{{ $Categorie->id }}</td>
              ...
              &nbsp;
              &nbsp;
              <a href="{{route('Categorie.edit',$Categorie->id)}}"><i class="bi bi-pencil" ></i></a>
                    </td>
          </tr>
      @endforeach
  </tbody>
  ...
  <a style="margin-left: 70%; margin-top:20%;"  href="{{route('Categorie.create')}}"><i style="font-size:70px; color: #008037" class="bi bi-plus-circle-fill" ></i></a>
